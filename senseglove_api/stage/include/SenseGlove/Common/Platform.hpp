...
#if SG_COMPILER_CLANG && defined(__has_feature)
...
#define SG_HAS_EXCEPTIONS 1
#else   /* if SG_COMPILER_CLANG && defined(cxx_rtti) */
#define SG_HAS_EXCEPTIONS 0
#endif  /* if SG_COMPILER_CLANG && defined(cxx_rtti) */

/*******************************************************************************
* RTTI Detection
*******************************************************************************/

#if SG_COMPILER_CLANG && defined(cxx_rtti)
