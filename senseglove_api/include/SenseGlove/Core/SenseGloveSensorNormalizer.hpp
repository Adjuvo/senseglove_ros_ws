...
public:
    ...
    /// <returns></returns>
    [[nodiscard]] float NormalizeFlexion(int32_t finger, float sumFlexionAngles) const;
    ...
    /// <returns></returns>
    [[nodiscard]] float NormalizeAbduction(int32_t finger, float sumAbductionAngles) const;
};