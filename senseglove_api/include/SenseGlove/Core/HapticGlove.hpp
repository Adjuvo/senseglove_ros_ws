...
public:
    [[nodiscard]] static std::string ToString(EHapticGloveCalibrationState state);

    [[nodiscard]] static std::string ToString(EHapticLocation location);
...
public:
    ...
    [[nodiscard]] virtual EHapticGloveCalibrationState GetCalibrationState() const;
    ...
    [[nodiscard]] virtual std::string GetCalibrationInstruction() const;
...
public:
    ...
    /// <returns></returns>
    [[nodiscard]] virtual bool SupportsCustomWaveform(EHapticLocation atLocation) const;
