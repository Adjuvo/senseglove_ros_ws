...
public:
    ...
    [[nodiscard]] std::vector<Kinematics::Vect3D> GetJointPositions() const;
...
public:
    ...
    /// <returns></returns>
    [[nodiscard]] Kinematics::Vect3D GetPosition(ECVHandPoints location) const;

    /// <summary> Safely retrieve the location of a specific joint. </summary>
    /// <param name="location"></param>
    /// <returns></returns>
    [[nodiscard]] Kinematics::Vect3D GetPositionByIndex(int32_t location) const;
    ...
    /// <returns></returns>
    [[nodiscard]] bool MatchesDevice(bool bRight, SGCore::EDeviceType type, const std::string& hardwareVersion);

    /// <summary> Returns true if this pose was made for the same device as another pose. </summary>
    /// <param name="otherPose"></param>
    /// <returns></returns>
    [[nodiscard]] bool MatchesDevice(const CVHandTrackingData& otherPose);
    ...
    /// <returns></returns>
    [[nodiscard]] std::string PrintKeyPoints(const std::string& delimiter = ", ");
};