...
public:
    ...
    [[nodiscard]] const std::vector<std::vector<Kinematics::Vect3D>>& GetJointPositions() const;

    /// <summary> Quaternion rotation of each glove joint, relative to the Glove Origin. </summary>
    [[nodiscard]] const std::vector<std::vector<Kinematics::Quat>>& GetJointRotations() const;
