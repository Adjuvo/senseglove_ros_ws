...
public:
    ...
    /// <returns></returns>
    [[nodiscard]] static std::string ToString(EWaveformType type);
...
public:
    ...
    /// <returns></returns>
    [[nodiscard]] EWaveformType GetWaveType() const;
    ...
    /// </summary>
    /// <returns></returns>
    [[nodiscard]] int32_t GetRepeatAmount() const;
    ...
    /// <returns></returns>
    [[nodiscard]] float GetAttackTime() const;
    ...
    /// <returns></returns>
    [[nodiscard]] float GetSustainTime() const;
    ...
    /// Gloves. </summary>
    /// <returns></returns>
    [[nodiscard]] float GetFrequencyStart() const;
    ...
    /// Gloves. </summary>
    /// <returns></returns>
    [[nodiscard]] float GetFrequencyEnd() const;
    ...
    /// <returns></returns>
    [[nodiscard]] float GetFrequencySwitchTime() const;
    ...
    /// [1x .. 3x]. </summary>
    /// <returns></returns>
    [[nodiscard]] float GetFrequencySwitchFactor() const;
