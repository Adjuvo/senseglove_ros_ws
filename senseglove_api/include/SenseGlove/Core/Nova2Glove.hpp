...
public:
    ...
    [[nodiscard]] static std::vector<Nova2Glove> GetNova2Gloves();
...
public:
    ...
    /// <returns></returns>
    [[nodiscard]] static char GetStreamByte();

    /// <summary> Ranges before a Nova 2.0 Sensor is allowed to move. </summary>
    [[nodiscard]] static const std::vector<float>& GetNova2SensorRanges();
...
public:
    ...
    /// <returns></returns>
    [[nodiscard]] static std::vector<float> ToNormalizedValues(const Nova2GloveSensorData& sensorData);

    /// <summary> Convert Sensor Data into a series of normalized values. </summary>
    /// <param name="sensorData"></param>
    /// <param name="out_sensorNormalizer"></param>
    /// <returns></returns>
    [[nodiscard]] static std::vector<float> ToNormalizedValues(
...
public:
    ...
    /// <returns></returns>
    [[nodiscard]] static std::vector<std::vector<Kinematics::Vect3D>> CalculateHandAngles(
    ...
    /// <returns></returns>
    [[nodiscard]] static std::vector<std::vector<Kinematics::Vect3D>> ToNormalizedAngles(
...
protected:
    ...
    [[nodiscard]] static std::string ToStreamCommand(const std::vector<float>& forceFeedbackLevels, float squeezeLevel);
...
public:
    ...
    /// <returns></returns>
    [[nodiscard]] virtual const std::string& GetDeviceId() const override;

    /// <summary> Access this device's hardware designation. </summary>
    /// <returns></returns>
    [[nodiscard]] virtual const std::string& GetHardwareVersion() const override;
...
public:
    ...
    /// <returns></returns>
    [[nodiscard]] virtual EHapticGloveCalibrationState GetCalibrationState() const override;
    ...
    /// <returns></returns>
    [[nodiscard]] virtual bool SupportsCustomWaveform(EHapticLocation atLocation) const override;
    ...
    /// <returns></returns>
    [[nodiscard]] virtual bool QueueSqueezeLevel(float squeezeLevel01);
...
public:
    ...
    /// <returns></returns>
    [[nodiscard]] bool DoesIndexInfluenceOthers() const;
    ...
    /// <returns></returns>
    [[nodiscard]] bool SupportsOnBoardNormalization() const;
...
public:
    ...
    /// <param name="location"></param>
    /// <returns></returns>
    [[nodiscard]] virtual ENova2VibroMotor ToNova2Motor(EHapticLocation location) const;

    /// <summary> Returns the channel index for a particular motor. Can make this as complex as I want for the Nova
    /// GLove(s). </summary>
    /// <param name="motor"></param>
    /// <returns></returns>
    [[nodiscard]] virtual int32_t ChannelIndex(ENova2VibroMotor motor) const;
