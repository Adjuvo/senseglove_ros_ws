...
public:
    ...
    [[nodiscard]] static char GetHapticsByte();

    /// <summary> Byte indicating a new Nova thresholds command. </summary>
    [[nodiscard]] static char GetThresholdsByte();

    /// <summary> Byte to ignore Thresholds. </summary>
    [[nodiscard]] static char GetIgnoreThresholdsByte();

    /// <summary> Ranges before a Nova 1.0 Sensor is allowed to move. </summary>
    [[nodiscard]] static const std::vector<float>& GetNovaSensorRanges();
...
public:
    ...
    /// <param name="location"></param>
    /// <returns></returns>
    [[nodiscard]] virtual ENovaVibroMotor ToNovaMotor(EHapticLocation location) const;

    /// <summary> Returns the channel index for a particular motor. Can make this as complex as I want for the Nova
    /// GLove(s). </summary>
    /// <param name="motor"></param>
    /// <returns></returns>
    [[nodiscard]] virtual int32_t ChannelIndex(ENovaVibroMotor motor) const;
