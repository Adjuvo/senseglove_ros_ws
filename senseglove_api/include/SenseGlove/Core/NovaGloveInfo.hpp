...
public:
    ...
    /// <returns></returns>
    [[nodiscard]] static NovaGloveInfo Deserialize(const std::string& serializedString);
...
public:
    ...
    /// <returns></returns>
    [[nodiscard]] bool FirmwareNewerThan(int32_t firmwareMain, int32_t firmwareSub, bool bInclusive) const;
    ...
    /// <param name="bInclusive"></param>
    /// <returns></returns>
    [[nodiscard]] bool FirmwareOlderThan(int32_t firmwareMain, int32_t firmwareSub, bool bInclusive) const;

public:
    /// <summary> Returns true if this GloveInfo contains the same information as another. </summary>
    /// <param name="other"></param>
    /// <returns></returns>
    [[nodiscard]] bool Equals(const NovaGloveInfo& novaGloveInfo) const;
