...
public:
    ...
    /// <returns></returns>
    [[nodiscard]] static HandProfile Default(bool bRightHanded);

    /// <summary> Convert a string notation of a NovaGloveHandProfile into a new instance. </summary>
    /// <param name="serializedString"></param>
    /// <returns></returns>
    [[nodiscard]] static HandProfile Deserialize(const std::string& serializedString);
...
public:
    ...
    [[nodiscard]] static const std::string& GetLeftHandFileName();

    /// <summary> Filename for the right hand profile. </summary>
    [[nodiscard]] static const std::string& GetRightHandFileName();

    /// <summary> Returns the fileName of the left or right-handed profiles. </summary>
    /// <param name="bRightHanded"></param>
    /// <returns></returns>
    [[nodiscard]] static const std::string& GetProfileFileName(bool bRightHanded);
...
public:
    ...
    [[nodiscard]] SG::SenseGloveHandProfile& GetSenseGloveHandProfile() const;

    /// <summary> User profile for Nova. </summary>
    [[nodiscard]] Nova::NovaGloveHandProfile& GetNovaGloveHandProfile() const;

public:
    [[nodiscard]] bool Equals(const HandProfile& handProfile) const;
