...
public:
    ...
    /// <param name="b"></param>
    /// <returns></returns>
    [[nodiscard]] static float DotProduct(const Vect3D& a, const Vect3D& b);
    ...
    /// <param name="b"></param>
    /// <returns></returns>
    [[nodiscard]] static Vect3D CrossProduct(const Vect3D& a, const Vect3D& b);
    ...
    /// <param name="v2"></param>
    /// <returns></returns>
    [[nodiscard]] static float AngleBetween(const Vect3D& v1, const Vect3D& v2);
