...
public:
    ...
    [[nodiscard]] virtual const std::string& GetDeviceId() const
    ...
    [[nodiscard]] virtual const std::string& GetHardwareVersion() const
#if ! SENSEGLOVE_UNREAL_ENGINE_PLUGIN
        = 0
#endif  /* ! SENSEGLOVE_UNREAL_ENGINE_PLUGIN */
    ;
    ...
    [[nodiscard]] virtual const std::string& GetFirmwareString() const;
...
public:
    ...
    /// <returns></returns>
    [[nodiscard]] int32_t GetHapticChannelCount() const;

    /// <summary> How many channels of a specific type this SGDevice possesses. </summary>
    /// <param name="channelType"></param>
    /// <returns></returns>
    [[nodiscard]] int32_t GetHapticChannelCount(EHapticChannelType channelType) const;
