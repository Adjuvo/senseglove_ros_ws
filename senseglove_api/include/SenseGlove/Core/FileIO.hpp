...
public:
    ...
    /// <returns></returns>
    [[nodiscard]] static bool DirectoryExists(const std::string& directoryPath);
    ...
    /// <returns></returns>
    [[nodiscard]] static std::string GetMyDocumentsPath();

    /// <summary> Get the Path to XDG_CONFIG_HOME on non-Windows platforms. </summary>
    /// <returns></returns>
    [[nodiscard]] static std::string GetXdgConfigHomePath();
    ...
    /// <returns></returns>
    [[nodiscard]] static std::string GetSenseGloveHomePath();
