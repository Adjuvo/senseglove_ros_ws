...
public:
    ...
    /// <returns></returns>
    [[nodiscard]] static Nova2GloveSensorData Parse(const std::string& rawData, const NovaGloveInfo& gloveInfo);
...
public:
    ...
    [[nodiscard]] const std::vector<std::vector<Kinematics::Vect3D>>& GetSensorValues() const;
...
public:
    ...
    [[nodiscard]] float GetSensorValue(SGCore::EFinger finger, Nova2GloveSensorData::ESensorLocation location) const;
...
public:
    ...
    [[nodiscard]] Kinematics::Quat GetImuRotation() const;
...
public:
    ...
    /// <returns></returns>
    [[nodiscard]] bool Equals(const Nova2GloveSensorData& nova2GloveSensorData) const;
