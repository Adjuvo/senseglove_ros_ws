...
public:
    ...
    /// <returns></returns>
    [[nodiscard]] float GetThreshold(int32_t finger) const;
    ...
    [[nodiscard]] std::vector<float> GetThresholds() const;
    ...
    /// <param name="finger"></param>
    /// <returns></returns>
    [[nodiscard]] bool GetFingerActive(int32_t finger) const;

    [[nodiscard]] std::vector<bool> GetActiveFingers() const;
...
public:
    ...
    /// <returns></returns>
    [[nodiscard]] bool Equals(const ThresholdCommand& thresholdCommand) const;
