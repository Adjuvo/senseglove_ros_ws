...
public:
    ...
    [[nodiscard]] static char FloatToSGByte(float level01);
    ...
    /// <returns></returns>
    [[nodiscard]] static std::string ToSGBytes(const std::vector<float>& values01, int32_t messageLength, float fallbackValue = 0.0f);
    ...
    /// <returns></returns>
    [[nodiscard]] static int32_t EncodeLinear(float value, float minValue, float maxValue, int32_t minByte = 1, int32_t maxByte = 101);
    ...
    /// <param name="maxByte"></param>
    /// <returns></returns>
    [[nodiscard]] static float DecodeLinear(int byteFromChar, float minValue, float maxValue, int32_t minByte = 1, int32_t maxByte = 101);
