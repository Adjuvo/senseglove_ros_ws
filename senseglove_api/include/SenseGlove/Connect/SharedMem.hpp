...
public:
    ...
    [[nodiscard]] static uint32_t GetStandardSize();

    [[nodiscard]] static const std::string& GetReleaseIdleConnections();// = "idleRelease";

    [[nodiscard]] static const std::string& GetHapticUpdate();//"hUpd";
...
public:
    ...
    static bool ReadFrom(const std::string& block, const std::string& address, std::string& out_value, bool shouldExist = true);
    ...
    static void SetHostingProcess(const bool bIsHosting);
