...
if(NOT "/home/rogier/SenseGlove_ROS/ros_workspace/build/senseglove_shared_resources/devel/include " STREQUAL " ")
  set(senseglove_shared_resources_INCLUDE_DIRS "")
  set(_include_dirs "/home/rogier/SenseGlove_ROS/ros_workspace/build/senseglove_shared_resources/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'senseglove_shared_resources' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rogier/SenseGlove_ROS/ros_workspace/src/senseglove/senseglove_shared_resources/${idir}'.  ${_report}")
    endif()
