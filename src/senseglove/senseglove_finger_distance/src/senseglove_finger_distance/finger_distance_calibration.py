...
class Calibration:
    ...
    def __init__(self, glove_nr=1, name="default"):
        ...
        # Defaults
        self.pinch_calibration_min = [0.0, 0.0, 0.0]  # [index, middle, ring] in mm
        self.pinch_calibration_max = [100.0, 100.0, 100.0]
    ...
    def is_calibrated(self):
        if self.cancelled:
            return False
        return (self.finished_open_flat and self.finished_thumb_index_pinch and
                self.finished_thumb_middle_pinch and self.finished_thumb_ring_pinch)
