...
To calibrate a right-handed glove, use: 
```
rosservice call /senseglove_finger_distance_right/Calibrate right
```

Upon launching either service, a GUI will appear to guide you through the calibration process. Once completed, the resulting parameters will be stored in the calibration folder located at the [calibration folder](src/senseglove/senseglove_shared_resources/calibration/).
